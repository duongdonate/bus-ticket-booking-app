...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("w-full min-w-64", defaultClassNames.root),
        months: cn(
        ...
        dropdown_root: cn(
          "relative has-focus:border-ring border border-border shadow-xs has-focus:ring-ring has-focus:ring-[3px] rounded-md",
